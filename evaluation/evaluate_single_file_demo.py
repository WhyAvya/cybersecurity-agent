# evaluation/evaluate_single_file_demo.py
...
def print_metrics(title, metrics):
    ...
    if metrics["fpr"] is None:
        print("FPR      : Not meaningful for this one vulnerable-only file")
    else:
...
def main():
    ...
    # Raw finding-level evaluation:
    # In this intentionally vulnerable demo file, all Semgrep findings correspond
    # to vulnerable code locations or duplicate rules around those vulnerable lines.
    ...
    strict_category_metrics = calculate_metrics(
    ...
    review_category_metrics = calculate_metrics(
